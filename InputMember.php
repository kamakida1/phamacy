...
$Password=$_POST['Password'];
  ...
  $sql="insert into member(UserID,Username,Email,Password)
  value('$UserID','$Username','$Email','$Password') ";
    ...
    <form class="center" action='' method="POST">
      <fieldset class="registration-form">
        ...
        <div class="control-group">
          <!-- E-mail -->
          <div class="controls">
            <input type="text" id="UserID" name="UserID" placeholder="UserID" class="input-xlarge">
          </div>
          <div class="controls">
        ...
        <div class="control-group">
          <!-- Button -->
          <div class="controls">
             <button class="btn btn-success btn-large btn-block">บันทึกประวัติ</button>
          </div>
        </div>
      </fieldset>
    </form>
