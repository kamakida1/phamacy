...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
    ...
    <li><span class="glyphicon glyphicon-home"></span> <a href="Home.html">จัดการระบบ</a></li>
        <li> <span class="glyphicon glyphicon-user"></span></span> <a href=MemberBack.php>รายชื่อสมาชิก</a><li>     
  </ol>
...
<br>
  <center><h2>สมาชิกที่เข้าระบบ</h2><br>
 
    <table width="80%" border="1"  id="customers">
  <tr>
     <th width="10"> <div align="center">UserID </div></th>
  ...
  <?php
    ...
    <td><div align="center"><?php echo $row["Username"];?></td>
    <td><div align="center"><?php echo $row["Email"];?></td>
   <td><div align="center"><?php echo $row["Password"];?></td>
    <td><div align="center"> <?php echo date("d/m/Y H:i:s",$datenow); ?>
</td>
