...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
    ...
    <li><span class="glyphicon glyphicon-home"></span> <a href="Home.html">จัดการระบบ</a></li>
        <li> <span class="glyphicon glyphicon-file"></span></span> <a href=blanks.html>บทความ</a><li>     
  </ol>


                     <a href="uis.php" class="btn btn-warning btn-lg">
          <span class="glyphicon glyphicon-plus"></span> เพิ่มบทความ 
        </a>
...
<br>
  <center><h2>บทความ</h2><br>
 
    <table width="80%" border="1"  id="customers">
  <tr>
     <th width="10"> <div align="center">ไอดี </div></th>
    <th width="20"> <div align="center">ชื่อบทความ </div></th>
    <th width="20"> <div align="center">หมวดหมู่ </div></th>
    <th width="20"> <div align="center">เข้าชม</div></th>
     <th width="20"> <div align="center">โดย</div></th>
      <th width="10"> <div align="center">วันที่สร้าง </div></th>
    <th width="20"> <div align="center">สถานะ </div></th>
    <th width="20"> <div align="center">เคร ื่องมือ </div></th>
  ...
  <?php
   ...
   <form method="post" action="checkbox.php">
    ...
    <td><div align="center"><?php echo $row["category"];?></td>
      <td><div align="center"><?php echo $row["visit"];?></div></td>
    <td><div align="center"><?php echo $row["by"];?></td>
    <td><div align="center"><?php echo $row["date"];?></td>
      <td><div align="center"><?php echo $row["status"];?></td>
