...
<body>
  ...
  <header class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><a data-toggle="modal"><i class="icon-lock"></i>
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="login.php">ผู้ใช้งาน</a></li>
      <li><a href="loginAdmin.php">ผู้ดูแลระบบ</a></li>
     <li><a href="index.html">ออกระบบ</a></li>
            </li>
          </ul>        
        </div><!--/.nav-collapse -->
      </div>
  ...
  <section id="registration-page" class="container">
    <form class="center" action="checklogin.php" method="post">
      <fieldset class="registration-form">
        ...
        <div class="control-group">
          <!-- Button -->
          <div class="controls">
            <button class="btn btn-success btn-large btn-block">เข้าสู่ระบบ</button>
            <br>
