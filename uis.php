...
//require './headerBalck.php';
  ...
  $sql="insert into drug(ID,name,price,photo)
  value('$ID','$name','$price','$photo') ";
      ...
      <fieldset class="registration-form">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            ...
            รหัสสินค้า : <input type="text" id="ID" name="ID" placeholder="ID" class="input-xlarge">
          </div>
        ...
        <div class="control-group">
          <!-- E-mail -->
          <div class="controls">
            ชื่อสินค้า : <input type="text" id="name" name="name" placeholder="name" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          <!-- Password-->
          <div class="controls">
            ราคาสินค้า :  <input type="password" id="price" name="price" placeholder="price" class="input-xlarge">
          </div>
        </div>
...
<img id="blah" src="http://placehold.it/180" alt="your image" />
        ...
        <div class="control-group">
          <!-- Button -->
          <div class="controls">
            <br> <button class="btn btn-success ">เพิ่มสินค้า</button>   <a href="ProductBlack.php">สินค้าในคลัง</a>
